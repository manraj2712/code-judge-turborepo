            ...
            <button
              className={
                selectedTab === item.name
                  ? "bg-neutral-700/80 text-white rounded-md px-3 py-2 text-sm font-medium"
                  : " rounded-md px-3 py-2 text-sm font-medium text-gray-500 hover:bg-gray-600 hover:text-white"
              }
