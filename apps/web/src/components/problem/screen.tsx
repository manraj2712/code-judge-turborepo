...
export default function ProblemSubmittionScreen({ problem }: { problem: Problem }) {
        ...
        <div>
            ...
            <div className="lg:hidden px-7 pt-3 relative">
                <ProblemHeaderComponent
                    header={problem.header}
                ></ProblemHeaderComponent>
                <ProblemDescription description={problem.description}></ProblemDescription>
                <ProblemDescription description={problem.description}></ProblemDescription>
                <ProblemDescription description={problem.description}></ProblemDescription>
                <div
