...
const Loading = () => {
  return (
    <div className="flex flex-row w-full h-full">
      <div className="flex flex-col sm:block w-80 xl:w-56 p-3 animate-pulse bg-neutral-900 shadow duration-300 overflow-y-auto">
        <table>
          <tbody>
            {fakeData.map((i) => (
              <tr
              ...
              >
                <td>
                 <div className='hidden lg:flex mb-4 bg-slate-500 px-20 py-1 text-base'></div>
                </td>
              </tr>
            ))}
          </tbody>
                  ...
                  {fakeData.map((i) => (
                    ...
                    >
                      <td className="hidden lg:table-cell px-6 py-4 text-base">
                        <div className='hidden lg:table-cell h-1 w-[30%] bg-slate-500 px-10 py-1 text-base'></div>
                        {/* {i.status} */}
                      </td>
